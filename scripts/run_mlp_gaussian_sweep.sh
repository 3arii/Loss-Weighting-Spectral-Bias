...
#SBATCH --array=0-4
#SBATCH -o /n/holylfs06/LABS/kempner_fellow_binxuwang/Users/binxuwang/step1_results/slurm_logs/mlp_gauss_%A_%a.out
#SBATCH -e /n/holylfs06/LABS/kempner_fellow_binxuwang/Users/binxuwang/step1_results/slurm_logs/mlp_gauss_%A_%a.err

# Beta sweep on diagonal-Gaussian data, shared MLP denoiser.
# Produces per-beta JSON with trained alpha + phi-integral prediction.
